#[allow(missing_docs)]
#[doc = r" An owned fragment of the AST: this `enum` can represent any node in the AST."]
...
#[allow(missing_docs)]
#[doc = r" An borrowed fragment of the AST: this `enum` can represent any node in the AST."]
