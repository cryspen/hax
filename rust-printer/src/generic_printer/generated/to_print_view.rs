impl<'a> ToPrintView<'a> for origin::GenericValue {
    type Viewed = destination::GenericValue<'a>;
    fn to_print_view(
        &'a self,
...
impl<'a> ToPrintView<'a> for origin::PrimitiveTy {
    type Viewed = destination::PrimitiveTy<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Region {
    type Viewed = destination::Region;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Ty {
    type Viewed = destination::Ty<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self {
            origin::Ty(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(Ty), "::", stringify!(anon_field_0))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                destination::Ty(anon_field_0)
            }
        }
    }
}
impl<'a> ToPrintView<'a> for origin::TyKind {
    type Viewed = destination::TyKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self {
            origin::TyKind::Primitive(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Primitive),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Primitive(anon_field_0)
            }
            origin::TyKind::Tuple(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Tuple),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Tuple(anon_field_0)
            }
            origin::TyKind::App { head, args } => {
                let head = {
                    let context = PrintContext {
                        value: head,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::App), "::", stringify!(head))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                let args = {
                    let context = PrintContext {
                        value: args,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::App), "::", stringify!(args))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                destination::TyKind::App { head, args }
            }
            origin::TyKind::Arrow { inputs, output } => {
                let inputs = {
                    let context = PrintContext {
                        value: inputs,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Arrow), "::", stringify!(inputs))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                let output = {
                    let context = PrintContext {
                        value: output,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Arrow), "::", stringify!(output))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                destination::TyKind::Arrow { inputs, output }
            }
            origin::TyKind::Ref {
                inner,
                mutable,
                ...
                let inner = {
                    let context = PrintContext {
                        value: inner,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Ref), "::", stringify!(inner))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                let mutable = {
                    let context = PrintContext {
                        value: mutable,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Ref), "::", stringify!(mutable))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                let region = {
                    let context = PrintContext {
                        value: region,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Ref), "::", stringify!(region))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                destination::TyKind::Ref {
                    inner,
                    mutable,
                    region,
                }
            }
            origin::TyKind::Param(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Param),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Param(anon_field_0)
            }
            origin::TyKind::Slice(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Slice),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Slice(anon_field_0)
            }
            origin::TyKind::Array { ty, length } => {
                let ty = {
                    let context = PrintContext {
                        value: ty,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Array), "::", stringify!(ty))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                let length = {
                    let context = PrintContext {
                        value: length,
                        payload: PrintContextPayload {
                            position: concat!(stringify!(TyKind::Array), "::", stringify!(length))
                                .into(),
                            parent: parent_context.clone(),
                        },
                    };
                ...
                destination::TyKind::Array { ty, length }
            }
            origin::TyKind::RawPointer => destination::TyKind::RawPointer,
            origin::TyKind::AssociatedType { impl_, item } => {
                let impl_ = {
                    let context = PrintContext {
                        value: impl_,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::AssociatedType),
                                "::",
                                stringify!(impl_)
                            )
                            .into(),
                ...
                destination::TyKind::AssociatedType { impl_, item }
            }
            origin::TyKind::Opaque(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Opaque),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Opaque(anon_field_0)
            }
            origin::TyKind::Dyn(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Dyn),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Dyn(anon_field_0)
            }
            origin::TyKind::Error(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(TyKind::Error),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::TyKind::Error(anon_field_0)
            }
        }
    }
}
impl<'a> ToPrintView<'a> for origin::DynTraitGoal {
    type Viewed = destination::DynTraitGoal<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Metadata {
    type Viewed = destination::Metadata<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Expr {
    type Viewed = destination::Expr<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Guard {
    type Viewed = destination::Guard<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::BorrowKind {
    type Viewed = destination::BorrowKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::BindingMode {
    type Viewed = destination::BindingMode<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::PatKind {
    type Viewed = destination::PatKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self {
            ...
            origin::PatKind::Ascription { pat, ty } => {
                let pat = {
                    let context = PrintContext {
                        value: pat,
                        payload: PrintContextPayload {
                ...
                destination::PatKind::Ascription { pat, ty }
            }
...
impl<'a> ToPrintView<'a> for origin::GuardKind {
    type Viewed = destination::GuardKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ImplExpr {
    type Viewed = destination::ImplExpr<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ImplExprKind {
    type Viewed = destination::ImplExprKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ImplItem {
    type Viewed = destination::ImplItem<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ImplItemKind {
    type Viewed = destination::ImplItemKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::TraitItem {
    type Viewed = destination::TraitItem<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::TraitItemKind {
    type Viewed = destination::TraitItemKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::QuoteContent {
    type Viewed = destination::QuoteContent<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self {
            ...
            origin::QuoteContent::Ty(anon_field_0) => {
                let anon_field_0 = {
                    let context = PrintContext {
                        value: anon_field_0,
                        payload: PrintContextPayload {
                            position: concat!(
                                stringify!(QuoteContent::Ty),
                                "::",
                                stringify!(anon_field_0)
                            )
                            .into(),
                ...
                destination::QuoteContent::Ty(anon_field_0)
            }
        }
    }
}
impl<'a> ToPrintView<'a> for origin::Quote {
    type Viewed = destination::Quote<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ItemQuoteOrigin {
    type Viewed = destination::ItemQuoteOrigin<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ItemQuoteOriginKind {
    type Viewed = destination::ItemQuoteOriginKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ItemQuoteOriginPosition {
    type Viewed = destination::ItemQuoteOriginPosition;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::LoopKind {
    type Viewed = destination::LoopKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self {
            ...
            origin::LoopKind::ForLoop { pat, iterator } => {
                let pat = {
                    let context = PrintContext {
                        value: pat,
                        payload: PrintContextPayload {
                ...
                destination::LoopKind::ForLoop { pat, iterator }
            }
...
impl<'a> ToPrintView<'a> for origin::ControlFlowKind {
    type Viewed = destination::ControlFlowKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::LoopState {
    type Viewed = destination::LoopState<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ExprKind {
    type Viewed = destination::ExprKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self {
            ...
            origin::ExprKind::AddressOf { mutable, inner } => {
                let mutable = {
                    let context = PrintContext {
                        value: mutable,
                        payload: PrintContextPayload {
                ...
                destination::ExprKind::AddressOf { mutable, inner }
            }
...
impl<'a> ToPrintView<'a> for origin::GenericParamKind {
    type Viewed = destination::GenericParamKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::TraitGoal {
    type Viewed = destination::TraitGoal<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ImplIdent {
    type Viewed = destination::ImplIdent<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ProjectionPredicate {
    type Viewed = destination::ProjectionPredicate<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::GenericConstraint {
    type Viewed = destination::GenericConstraint<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::GenericParam {
    type Viewed = destination::GenericParam<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Generics {
    type Viewed = destination::Generics<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::SafetyKind {
    type Viewed = destination::SafetyKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Attribute {
    type Viewed = destination::Attribute<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::AttributeKind {
    type Viewed = destination::AttributeKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::DocCommentKind {
    type Viewed = destination::DocCommentKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::SpannedTy {
    type Viewed = destination::SpannedTy<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Param {
    type Viewed = destination::Param<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Variant {
    type Viewed = destination::Variant<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ItemKind {
    type Viewed = destination::ItemKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::Item {
    type Viewed = destination::Item<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ResugaredExprKind {
    type Viewed = destination::ResugaredExprKind<'a>;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
...
impl<'a> ToPrintView<'a> for origin::ResugaredPatKind {
    type Viewed = destination::ResugaredPatKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
        match self { _ => unreachable ! ("no variant, but references are always inhabited (see https://github.com/rust-lang/rust/issues/78123)") }
    }
}
impl<'a> ToPrintView<'a> for origin::ResugaredTyKind {
    type Viewed = destination::ResugaredTyKind;
    fn to_print_view(
        &'a self,
        #[allow(unused_variables)] parent_context: Option<std::rc::Rc<ParentPrintContext<'a>>>,
    ) -> Self::Viewed {
