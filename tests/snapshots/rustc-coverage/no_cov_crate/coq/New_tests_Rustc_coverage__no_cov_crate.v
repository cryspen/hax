...
Definition do_not_add_coverage_1_ '(_ : unit) : unit :=
  let _ := e_print (impl_1__new_const ([("called but not covered
"%string : string)])) in
  let _ := tt in
  tt.
...
Definition do_not_add_coverage_not_called '(_ : unit) : unit :=
  let _ := e_print (impl_1__new_const ([("not called and not covered
"%string : string)])) in
  let _ := tt in
  tt.

Definition add_coverage_1_ '(_ : unit) : unit :=
  let _ := e_print (impl_1__new_const ([("called and covered
"%string : string)])) in
  let _ := tt in
  tt.
...
Definition add_coverage_not_called '(_ : unit) : unit :=
  let _ := e_print (impl_1__new_const ([("not called but covered
"%string : string)])) in
  let _ := tt in
  tt.
