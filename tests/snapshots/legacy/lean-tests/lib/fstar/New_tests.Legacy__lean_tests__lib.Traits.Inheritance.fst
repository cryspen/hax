module New_tests.Legacy__lean_tests__lib.Traits.Inheritance
...
let _ = fun (v_Self:Type0) {|i: t_T3 v_Self|} -> i._super_i0
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_Tp2 v_Self|} -> i._super_i0

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_Tp2 v_Self|} -> i._super_i1
