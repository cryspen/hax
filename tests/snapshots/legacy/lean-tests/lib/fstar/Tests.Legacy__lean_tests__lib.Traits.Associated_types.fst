...
class t_T3 (v_Self: Type0) = {
  f_T:Type0;
  f_T_4101979666136489415:t_Bar f_T;
  f_Tp:Type0;
  f_Tp_13521341099752925627:t_Foo f_Tp f_T;
...
class t_T2 (v_Self: Type0) = {
  f_T:Type0;
  f_T_83052203690501683:t_T1 f_T;
  f_f_pre:v_Self -> f_T -> Type0;
...
let impl_T2_for_S: t_T2 t_S =
  {
    f_T = t_S;
    f_T_83052203690501683 = FStar.Tactics.Typeclasses.solve;
