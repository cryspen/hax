module New_tests.Legacy__lean_tests__lib
...
let closure (_: Prims.unit) : i32 =
  ...
  in
  let res2:i32 =
    Core_models.Ops.Function.f_call #(i32 -> i32 -> i32)
      #(i32 & i32)
      #FStar.Tactics.Typeclasses.solve
      f2
...
(* item error backend: ((Diagnostics.Context.Backend FStar),
 Types.AssertionFailure {
   details =
   "Could not find item with UID (Attr_payloads.UId.T.UId \"7fa23e7023f441aca35a76c8687b567c\")"})

Last AST:
#[<cfg_attr_trace>(hax_compilation, _hax ::
json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"7fa23e7023f441aca35a76c8687b567c\"}}}"))]#[_hax::json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"7fa23e7023f441aca35a76c8687b567c\"}}}")]#[allow(dead_code)]#[allow(unused_variables)]#[allow(dead_code, unused, unconditional_recursion)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
...
(* item error backend: ((Diagnostics.Context.Backend FStar),
 Types.AssertionFailure {
   details =
   "Could not find item with UID (Attr_payloads.UId.T.UId \"6fb23cfd55864d5485a19b3e5c68a9f6\")"})

Last AST:
#[<cfg_attr_trace>(hax_compilation, _hax ::
json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"6fb23cfd55864d5485a19b3e5c68a9f6\"}}}"))]#[_hax::json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"6fb23cfd55864d5485a19b3e5c68a9f6\"}}}")]#[allow(dead_code)]#[allow(unused_variables)]#[allow(dead_code, unused, unconditional_recursion)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
