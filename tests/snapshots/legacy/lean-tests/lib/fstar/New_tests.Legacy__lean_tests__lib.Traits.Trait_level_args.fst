...
class t_T1 (v_Self: Type0) (v_A: Type0) (v_B: Type0) = {
  f_f1_pre:#v_C: Type0 -> #v_D: Type0 -> v_Self -> prop;
  f_f1_post:#v_C: Type0 -> #v_D: Type0 -> v_Self -> Prims.unit -> prop;
  f_f1:#v_C: Type0 -> #v_D: Type0 -> x0: v_Self
    -> Prims.Pure Prims.unit (f_f1_pre #v_C #v_D x0) (fun result -> f_f1_post #v_C #v_D x0 result);
  f_f2_pre:#v_C: Type0 -> #v_D: Type0 -> v_Self -> v_A -> prop;
  f_f2_post:#v_C: Type0 -> #v_D: Type0 -> v_Self -> v_A -> Prims.unit -> prop;
  ...
  f_f3_pre:#v_C: Type0 -> #v_D: Type0 -> v_Self -> v_A -> v_B -> prop;
  f_f3_post:#v_C: Type0 -> #v_D: Type0 -> v_Self -> v_A -> v_B -> Prims.unit -> prop;
