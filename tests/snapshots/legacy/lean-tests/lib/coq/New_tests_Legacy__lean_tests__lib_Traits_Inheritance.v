...
Instance t_T1_255958975 : t_T1 ((t_S)) :=
  {
    implaabbcc_t_T1_f_f1 := fun  (self : t_S)=>
      (1 : t_usize);
  }.

Instance t_T2_440300468 : t_T2 ((t_S)) :=
  {
    implaabbcc_t_T2_f_f2 := fun  (self : t_S)=>
      (2 : t_usize);
  }.

Instance t_T3_844564479 : t_T3 ((t_S)) :=
  {
    implaabbcc_t_T3_f_f3 := fun  (self : t_S)=>
      (3 : t_usize);
  }.

Instance t_Tp1_893806531 : t_Tp1 ((t_S)) :=
  {
    implaabbcc_t_Tp1_f_f1 := fun  (self : t_S)=>
      (10 : t_usize);
  }.

Instance t_Tp2_149762974 : t_Tp2 ((t_S)) :=
  {
