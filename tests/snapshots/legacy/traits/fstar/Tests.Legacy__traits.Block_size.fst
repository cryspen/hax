...
class t_ParBlocksSizeUser (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_1032993800281319343:t_BlockSizeUser v_Self
}

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_ParBlocksSizeUser v_Self|} -> i._super_1032993800281319343

class t_BlockBackend (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_12752098123861594988:t_ParBlocksSizeUser v_Self;
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_BlockBackend v_Self|} -> i._super_12752098123861594988
