...
class t_T (v_Self: Type0) (v_X: Type0) = {
  ...
  f_C:u8;
  f_f_pre:x: i1.f_A -> pred: Type0{true ==> pred};
  f_f_post:f_A -> u8 -> Type0;
  f_f:x0: f_A -> Prims.Pure u8 (f_f_pre x0) (fun result -> f_f_post x0 result);
  f_g_pre:v_Self -> f_A -> Type0;
  f_g_post:self_: v_Self -> x: i1.f_A -> result: i1.f_A -> pred: Type0{pred ==> true};
  ...
  f_h_pre:
      ...
      y: v_Y ->
      z: v_X
    -> pred: Type0{(f_C #FStar.Tactics.Typeclasses.solve <: u8) >. mk_u8 0 ==> pred};
  f_h_post:
      #v_Y: Type0 ->
      {| i1: Core_models.Convert.t_Into v_Y f_A |} ->
      x: i1.f_B ->
