...
Equations index_mutation (x : both (t_Range uint_size)) (a : both (seq int8)) : both 'unit :=
  index_mutation x a  :=
    letb v := impl__into_vec (unsize (array_from_list [ret_both (1 : int8)])) in
    letb v := impl__to_vec (update_at_range (impl_1__as_slice v) x (impl__copy_from_slice (v.a[x]) a)) in
    letb v := impl__to_vec (update_at_usize (impl_1__as_slice v) (ret_both (1 : uint_size)) (ret_both (3 : int8))) in
...
Equations build_vec (_ : both 'unit) : both (t_Vec int8 t_Global) :=
  build_vec _  :=
    impl__into_vec (unsize (array_from_list [ret_both (1 : int8);
      ret_both (2 : int8);
...
Equations test_append (_ : both 'unit) : both (t_Vec int8 t_Global) :=
  test_append _  :=
    ...
    letb vec2 := impl__into_vec (unsize (array_from_list [ret_both (1 : int8);
      ret_both (2 : int8);
      ret_both (3 : int8)])) in
...
Equations f (_ : both 'unit) : both (t_Vec int8 t_Global) :=
  f _  :=
    ...
    letb vec := impl__to_vec (impl__swap (impl_1__as_slice vec) (ret_both (0 : uint_size)) (ret_both (1 : uint_size))) in
    letb vec := impl__to_vec (impl__swap (impl_1__as_slice vec) (ret_both (0 : uint_size)) (ret_both (1 : uint_size))) in
...
Equations g (x : both (t_Pair (t_Vec int8 t_Global))) : both (t_Vec int8 t_Global) :=
  g x  :=
    ...
    letb x := Build_t_Pair[x] (f_a := impl__to_vec (impl__swap (impl_1__as_slice (f_a x)) (ret_both (0 : uint_size)) (ret_both (1 : uint_size)))) in
    letb x := Build_t_Pair[x] (f_b := Build_t_Foo[f_b x] (f_field := impl__to_vec (impl__swap (impl_1__as_slice (f_field (f_b x))) (ret_both (0 : uint_size)) (ret_both (1 : uint_size))))) in
...
Equations k (vec : both (t_Vec int8 t_Global)) (arg_1_wild3 : both int16) (arg_1_wild : both int8) (arg_3_wild2 : both 'unit) : both (t_Vec int8 t_Global × int16 × 'unit × int64) :=
  k vec arg_1_wild3 arg_1_wild arg_3_wild2  :=
    ...
    letb vec := impl__to_vec (update_at_usize (impl_1__as_slice vec) (ret_both (0 : uint_size)) ((((arg_1_wild .+ arg_3_wild) .+ arg_1_wild1) .+ arg_3_wild1) .+ arg_1_wild)) in
