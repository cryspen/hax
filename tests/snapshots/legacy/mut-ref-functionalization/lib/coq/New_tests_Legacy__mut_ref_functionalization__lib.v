...
Definition index_mutation (x : t_Range ((t_usize))) (a : t_Slice t_u8) : unit :=
  let v := impl__into_vec (unsize ([(1 : t_u8)])) in
  let v := impl__to_vec (update_at_range (impl_1__as_slice (v)) (x) (impl__copy_from_slice (f_index (v) (x)) (a))) in
  let v := impl__to_vec (update_at_usize (impl_1__as_slice (v)) ((1 : t_usize)) ((3 : t_u8))) in
  tt.
...
Definition build_vec '(_ : unit) : t_Vec ((t_u8)) ((t_Global)) :=
  impl__into_vec (unsize ([(1 : t_u8); (2 : t_u8); (3 : t_u8)])).

Definition test_append '(_ : unit) : t_Vec ((t_u8)) ((t_Global)) :=
  let vec1 := impl__new (tt) in
  let vec2 := impl__into_vec (unsize ([(1 : t_u8); (2 : t_u8); (3 : t_u8)])) in
...
Definition f '(_ : unit) : t_Vec ((t_u8)) ((t_Global)) :=
  ...
  let vec := impl__to_vec (impl__swap (impl_1__as_slice (vec)) ((0 : t_usize)) ((1 : t_usize))) in
  let vec := impl__to_vec (impl__swap (impl_1__as_slice (vec)) ((0 : t_usize)) ((1 : t_usize))) in
  vec.
...
Definition g (x : t_Pair ((t_Vec ((t_u8)) ((t_Global))))) : t_Vec ((t_u8)) ((t_Global)) :=
  ...
  let x := x <|t_Pairf_a := impl__to_vec (impl__swap (impl_1__as_slice (f_a x)) ((0 : t_usize)) ((1 : t_usize))) |> in
  let x := x <|t_Pairf_b := f_b x <|t_Foof_field := impl__to_vec (impl__swap (impl_1__as_slice (f_field f_b x)) ((0 : t_usize)) ((1 : t_usize))) |> |> in
  f_a x.
...
Definition k (vec : t_Vec ((t_u8)) ((t_Global))) (arg_1_wild3 : t_u16) (arg_1_wild : t_u8) (arg_3_wild2 : unit) : (t_Vec ((t_u8)) ((t_Global))*t_u16*unit*t_u64) :=
  ...
  let vec := impl__to_vec (update_at_usize (impl_1__as_slice (vec)) ((0 : t_usize)) (f_add (f_add (f_add (f_add (arg_1_wild) (arg_3_wild)) (arg_1_wild1)) (arg_3_wild1)) (arg_1_wild))) in
...
Instance t_FooTrait_105704208 : t_FooTrait ((t_Foo)) :=
  {
