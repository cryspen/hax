...
Instance t_T1_84342720 : t_T1 ((t_Foo)) :=
  {
  }.

Instance t_T1_44355219 : t_T1 (((t_Foo*t_u8))) :=
  {
  }.
...
Instance t_T2_for_a_497586169 : t_T2_for_a ((t_Arity1 (((t_Foo*t_u8))))) :=
  {
  }.
...
Instance t_T3_ee_for_a_248716750 : t_T3_ee_for_a ((t_Foo)) :=
  {
  }.
