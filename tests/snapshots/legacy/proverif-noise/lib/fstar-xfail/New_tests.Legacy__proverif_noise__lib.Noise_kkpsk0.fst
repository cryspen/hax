...
type t_HandshakeStateI0 = {
  f_st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState;
  f_psk:Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global;
  f_s:New_tests.Legacy__proverif_noise__lib.Noise_crypto.t_KeyPair;
  f_e:New_tests.Legacy__proverif_noise__lib.Noise_crypto.t_KeyPair;
...
type t_Transport = {
  f_send:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_CipherState;
  f_recv:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_CipherState;
...
let initialize_initiator
      ...
      (s e: New_tests.Legacy__proverif_noise__lib.Noise_crypto.t_KeyPair)
      (rs: t_Slice u8)
    : t_HandshakeStateI0 =
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.initialize_symmetric (v_Noise_KKpsk0_25519_ChaChaPoly_SHA256
          ._0
        <:
        t_Slice u8)
  in
  ...
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_hash st
      (Alloc.Vec.impl_1__as_slice s.New_tests.Legacy__proverif_noise__lib.Noise_crypto.f_public_key
        <:
        t_Slice u8)
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
...
let write_message1 (hs: t_HandshakeStateI0) (payload: t_Slice u8)
    : Core_models.Result.t_Result (t_HandshakeStateI1 & Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global)
      New_tests.Legacy__proverif_noise__lib.Noise_crypto.t_Error =
  let { f_st = st ; f_psk = psk ; f_s = s ; f_e = e ; f_rs = rs }:t_HandshakeStateI0 = hs in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_key_and_hash st
      (Alloc.Vec.impl_1__as_slice psk <: t_Slice u8)
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_hash st
      (Alloc.Vec.impl_1__as_slice e.New_tests.Legacy__proverif_noise__lib.Noise_crypto.f_public_key
        <:
        t_Slice u8)
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_key st
      (Alloc.Vec.impl_1__as_slice e.New_tests.Legacy__proverif_noise__lib.Noise_crypto.f_public_key
        <:
        t_Slice u8)
  in
  let es:Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global =
    New_tests.Legacy__proverif_noise__lib.Noise_crypto.dh e
      (Alloc.Vec.impl_1__as_slice rs <: t_Slice u8)
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_key st
      (Alloc.Vec.impl_1__as_slice es <: t_Slice u8)
  in
  let ss:Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global =
    New_tests.Legacy__proverif_noise__lib.Noise_crypto.dh s
      (Alloc.Vec.impl_1__as_slice rs <: t_Slice u8)
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_key st
      (Alloc.Vec.impl_1__as_slice ss <: t_Slice u8)
  in
  match
    New_tests.Legacy__proverif_noise__lib.Noise_lib.encrypt_and_hash st payload
    <:
    Core_models.Result.t_Result
      (New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState &
...
let read_message1 (hs: t_HandshakeStateR0) (ciphertext: t_Slice u8)
  ...
  let re:t_Slice u8 =
    ciphertext.[ {
        ...
        Core_models.Ops.Range.f_end = New_tests.Legacy__proverif_noise__lib.Noise_crypto.v_DHLEN
      }
      <:
  ...
  let ciphertext:t_Slice u8 =
    ciphertext.[ {
        Core_models.Ops.Range.f_start = New_tests.Legacy__proverif_noise__lib.Noise_crypto.v_DHLEN;
  ...
  in
  match
    New_tests.Legacy__proverif_noise__lib.Noise_lib.decrypt_and_hash st ciphertext
    <:
    Core_models.Result.t_Result
      (New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState &
        Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global)
...
let write_message2 (hs: t_HandshakeStateR1) (payload: t_Slice u8)
  ...
  let ee:Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global =
    New_tests.Legacy__proverif_noise__lib.Noise_crypto.dh e
      (Alloc.Vec.impl_1__as_slice re <: t_Slice u8)
  in
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_key st
      (Alloc.Vec.impl_1__as_slice ee <: t_Slice u8)
  in
  ...
  let st:New_tests.Legacy__proverif_noise__lib.Noise_lib.t_SymmetricState =
    New_tests.Legacy__proverif_noise__lib.Noise_lib.mix_key st
      (Alloc.Vec.impl_1__as_slice se <: t_Slice u8)
  in
  match
    New_tests.Legacy__proverif_noise__lib.Noise_lib.encrypt_and_hash st payload
    <:
  ...
  | Core_models.Result.Result_Ok (st, ciphertext) ->
    let
    (c1: New_tests.Legacy__proverif_noise__lib.Noise_lib.t_CipherState),
    (c2: New_tests.Legacy__proverif_noise__lib.Noise_lib.t_CipherState),
...
let write_transport (tx: t_Transport) (ad payload: t_Slice u8)
  ...
  match
    New_tests.Legacy__proverif_noise__lib.Noise_lib.encrypt_with_ad send ad payload
    <:
    Core_models.Result.t_Result
      (New_tests.Legacy__proverif_noise__lib.Noise_lib.t_CipherState &
        Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global)
      New_tests.Legacy__proverif_noise__lib.Noise_crypto.t_Error
  with
...
let read_transport (tx: t_Transport) (ad ciphertext: t_Slice u8)
  ...
  let { f_send = send ; f_recv = recv ; f_handshake_hash = handshake_hash }:t_Transport = tx in
  match
    New_tests.Legacy__proverif_noise__lib.Noise_lib.decrypt_with_ad recv ad ciphertext
    <:
    Core_models.Result.t_Result
      (New_tests.Legacy__proverif_noise__lib.Noise_lib.t_CipherState &
        Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global)
