module Tests.Legacy__lean_tests__src__traits.Inheritance
...
class t_T3 (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_14532845217727097520:t_T2 v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_2114861130552284825:t_T1 v_Self;
...
let _ = fun (v_Self:Type0) {|i: t_T3 v_Self|} -> i._super_14532845217727097520

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_T3 v_Self|} -> i._super_2114861130552284825
...
class t_Tp2 (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_7246171114968587502:t_Tp1 v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_1694037584750878299:t_T3 v_Self;
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_Tp2 v_Self|} -> i._super_7246171114968587502

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_Tp2 v_Self|} -> i._super_1694037584750878299
...
let impl_T3_for_S: t_T3 t_S =
  {
    _super_14532845217727097520 = FStar.Tactics.Typeclasses.solve;
    _super_2114861130552284825 = FStar.Tactics.Typeclasses.solve;
...
let impl_Tp2_for_S: t_Tp2 t_S =
  {
    _super_7246171114968587502 = FStar.Tactics.Typeclasses.solve;
    _super_1694037584750878299 = FStar.Tactics.Typeclasses.solve;
