module Tests.Rustc_tests__no_cov_crate
...
let main (_: Prims.unit) : Prims.unit =
  ...
  let _:Prims.unit = Tests.Rustc_tests__no_cov_crate.Nested_fns.outer_not_covered is_true in
  let _:Prims.unit = Tests.Rustc_tests__no_cov_crate.Nested_fns.outer is_true in
  let _:Prims.unit = Tests.Rustc_tests__no_cov_crate.Nested_fns.outer_both_covered is_true in
  ()
