module Tests.Legacy__proverif_ping_pong__src__lib.A
...
let write_ping (state: t_A0)
    : Core.Result.t_Result (t_A1 & Tests.Legacy__proverif_ping_pong__src__lib.t_Message)
      Hax_lib_protocol.t_ProtocolError =
  Core.Result.Result_Ok
  ((A1 <: t_A1),
    (Tests.Legacy__proverif_ping_pong__src__lib.Message_Ping state.f_data
      <:
      Tests.Legacy__proverif_ping_pong__src__lib.t_Message)
    <:
    (t_A1 & Tests.Legacy__proverif_ping_pong__src__lib.t_Message))
  <:
  Core.Result.t_Result (t_A1 & Tests.Legacy__proverif_ping_pong__src__lib.t_Message)
    Hax_lib_protocol.t_ProtocolError

let read_pong (e_state: t_A1) (msg: Tests.Legacy__proverif_ping_pong__src__lib.t_Message)
  ...
  | Tests.Legacy__proverif_ping_pong__src__lib.Message_Ping _ ->
    Core.Result.Result_Err
    (Hax_lib_protocol.ProtocolError_InvalidMessage <: Hax_lib_protocol.t_ProtocolError)
    <:
    Core.Result.t_Result t_A2 Hax_lib_protocol.t_ProtocolError
  | Tests.Legacy__proverif_ping_pong__src__lib.Message_Pong received ->
