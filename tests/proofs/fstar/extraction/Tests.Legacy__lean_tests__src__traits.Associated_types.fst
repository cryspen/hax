module Tests.Legacy__lean_tests__src__traits.Associated_types
...
class t_T3 (v_Self: Type0) = {
  f_T:Type0;
  f_T_3149366347871078545:t_Bar f_T;
  f_Tp:Type0;
  f_Tp_4283472258285251198:t_Foo f_Tp f_T;
...
class t_T2 (v_Self: Type0) = {
  f_T:Type0;
  f_T_2524289070217738876:t_T1 f_T;
  f_f_pre:v_Self -> f_T -> Type0;
...
let impl_T2_for_S: t_T2 t_S =
  {
    f_T = t_S;
    f_T_2524289070217738876 = FStar.Tactics.Typeclasses.solve;
