module Tests.Rustc_tests__inner_items
...
#[allow(unused_assignments, unused_variables, dead_code)]#[allow(dead_code)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
...
fn main__f_default_trait_func((self: Self)) -> Self{{let _: tuple0 = {tests::rustc_tests__inner_items::main__in_func(tests::rustc_tests__inner_items::main__v_IN_CONST)};{let self: Self = {tests::rustc_tests__inner_items::main__f_trait_func(self,tests::rustc_tests__inner_items::main__v_IN_CONST)};self}}}}
      ...
      (Some { Types.contents =
              { Types.id = 0;
                ...
                { Types.index = (0, 0, None); is_local = true;
                              ...
                              (Some { Types.contents =
                                      { Types.id = 0;
                                        ...
                                        { Types.index = (0, 0, None);
                                          ...
                                          krate = "tests"; parent = None;
                                          path = [] }
                                        }
                                      });
                              path =
                              [{ Types.data =
                                 (Types.TypeNs "rustc_tests__inner_items");
                                 disambiguator = 0 }
                                ]
                              }
                            }
                  ...
                  path =
                  [{ Types.data = (Types.TypeNs "rustc_tests__inner_items");
                     disambiguator = 0 };
