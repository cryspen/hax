module Tests.Rustc_tests__try_error_result
      ...
      (fun countdown temp_1_ ->
          ...
          then
            ...
            | Core.Result.Result_Ok hoist100 ->
              let _:Prims.unit =
                Core.Result.impl__expect_err #u32
                  #Prims.unit
                  (impl_Thing2__call hoist100 true <: Core.Result.t_Result u32 Prims.unit)
                  "call should fail"
              in
              (match
                  impl_Thing1__get_thing_2_ thing1 false <: Core.Result.t_Result t_Thing2 Prims.unit
                ...
                | Core.Result.Result_Ok hoist102 ->
                  let _:Prims.unit =
                    Core.Result.impl__expect_err #u32
                      #Prims.unit
                      (impl_Thing2__call hoist102 true <: Core.Result.t_Result u32 Prims.unit)
                      "call should fail"
                  in
                  (match
                    ...
                    | Core.Result.Result_Ok hoist104 ->
                      (match
                          impl_Thing2__call hoist104 true <: Core.Result.t_Result u32 Prims.unit
                        with
                        | Core.Result.Result_Ok v_val ->
                          ...
                          (match
                            ...
                            | Core.Result.Result_Ok hoist106 ->
                              (match
                                  impl_Thing2__call hoist106 false
                                  <:
            ...
            | Core.Result.Result_Ok hoist108 ->
              (match impl_Thing2__call hoist108 false <: Core.Result.t_Result u32 Prims.unit with
                | Core.Result.Result_Ok v_val ->
                  let _:Prims.unit =
                    match v_val, mk_u32 57 <: (u32 & u32) with
                  ...
                  (match
                    ...
                    | Core.Result.Result_Ok hoist110 ->
                      (match
                          impl_Thing2__call hoist110 false <: Core.Result.t_Result u32 Prims.unit
                        with
                        | Core.Result.Result_Ok v_val ->
                          let _:Prims.unit =
                            match v_val, mk_u32 57 <: (u32 & u32) with
                          ...
                          (match
                            ...
                            | Core.Result.Result_Ok hoist112 ->
                              (match
                                  impl_Thing2__call hoist112 false
                                  <:
                                  Core.Result.t_Result u32 Prims.unit
                                with
                                | Core.Result.Result_Ok v_val ->
