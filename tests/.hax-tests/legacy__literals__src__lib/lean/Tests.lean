...
def Tests.Legacy__literals__src__lib._.requires
  (x : Hax_lib.Int.Int)
  : Result Bool
  := do
...
def Tests.Legacy__literals__src__lib.math_integers
  (x : Hax_lib.Int.Int)
  : Result u8
  := do
...
def Tests.Legacy__literals__src__lib.panic_with_msg
...
structure Tests.Legacy__literals__src__lib.Foo where
  field : u8

instance Tests.Legacy__literals__src__lib.Impl :
  Core.Marker.StructuralPartialEq Tests.Legacy__literals__src__lib.Foo
  where


instance Tests.Legacy__literals__src__lib.Impl_1 :
  Core.Cmp.PartialEq
  Tests.Legacy__literals__src__lib.Foo
  Tests.Legacy__literals__src__lib.Foo
  where


instance Tests.Legacy__literals__src__lib.Impl_2 :
  Core.Cmp.Eq Tests.Legacy__literals__src__lib.Foo
  where


def Tests.Legacy__literals__src__lib.CONSTANT
  : Result Tests.Legacy__literals__src__lib.Foo
  := do
  (Tests.Legacy__literals__src__lib.Foo.mk (field := (3 : u8)))

def Tests.Legacy__literals__src__lib.numeric
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
...
def Tests.Legacy__literals__src__lib.patterns
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let _ ← (pure
  ...
  let _ ← (pure
    ...
    with
      ...
      | _ => do Rust_primitives.Hax.Tuple0.mk));
  let _ ← (pure
    (match (Tests.Legacy__literals__src__lib.Foo.mk (field := (4 : u8))) with
      | {field := TODO_LINE_622} => do Rust_primitives.Hax.Tuple0.mk
      | _ => do Rust_primitives.Hax.Tuple0.mk));
  Rust_primitives.Hax.Tuple0.mk

def Tests.Legacy__literals__src__lib.casts
  (x8 : u8)
  (x16 : u16)
  (x32 : u32)
  (x64 : u64)
...
def Tests.Legacy__literals__src__lib.empty_array
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
...
def Tests.Legacy__literals__src__lib.fn_pointer_cast
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
...
def Tests.Legacy__literals__src__lib.null : Char := ' '