...
def Tests.Rustc_tests__branch__while.while_cond
...
def Tests.Rustc_tests__branch__while.while_cond_not
  (_ : Rust_primitives.Hax.Tuple0)
  : Result (Rust_primitives.Hax.Tuple2 i32 Rust_primitives.Hax.Tuple0)
  := do
  let _ ← (pure
...
def Tests.Rustc_tests__branch__while.while_op_and
  (_ : Rust_primitives.Hax.Tuple0)
  : Result
...
def Tests.Rustc_tests__branch__while.while_op_or
  (_ : Rust_primitives.Hax.Tuple0)
  : Result
  (Rust_primitives.Hax.Tuple2
    (Rust_primitives.Hax.Tuple2 i32 i32)
...
def Tests.Rustc_tests__branch__while.main
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let _ ← (pure
    (← Tests.Rustc_tests__branch__while.while_cond
        Rust_primitives.Hax.Tuple0.mk));
  let _ ← (pure
    (← Tests.Rustc_tests__branch__while.while_cond_not
        Rust_primitives.Hax.Tuple0.mk));
  let _ ← (pure
    (← Tests.Rustc_tests__branch__while.while_op_and
        Rust_primitives.Hax.Tuple0.mk));
  let _ ← (pure
    (← Tests.Rustc_tests__branch__while.while_op_or
        Rust_primitives.Hax.Tuple0.mk));
  Rust_primitives.Hax.Tuple0.mk