module Tests.Legacy__lean_tests__src__traits.Bounds
...
class t_Test (v_Self: Type0) (v_T: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_11310229916574720283:t_T2 v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_10960389684919309101:t_T1 v_T;
...
let _ = fun (v_Self:Type0) (v_T:Type0) {|i: t_Test v_Self v_T|} -> i._super_11310229916574720283

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) (v_T:Type0) {|i: t_Test v_Self v_T|} -> i._super_10960389684919309101
...
let impl_2: t_Test t_S2 t_S1 =
  {
    _super_11310229916574720283 = FStar.Tactics.Typeclasses.solve;
