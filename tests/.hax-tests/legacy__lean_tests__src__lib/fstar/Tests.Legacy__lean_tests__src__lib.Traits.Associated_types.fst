module Tests.Legacy__lean_tests__src__lib.Traits.Associated_types
...
class t_T3 (v_Self: Type0) = {
  f_T:Type0;
  f_T_14848349073489618561:t_Bar f_T;
  f_Tp:Type0;
  f_Tp_200210290599988712:t_Foo f_Tp f_T;
  f_f_pre:#v_A: Type0 -> {| i2: t_Bar v_A |} -> v_Self -> f_T -> f_Tp -> Type0;
  f_f_post:#v_A: Type0 -> {| i2: t_Bar v_A |} -> v_Self -> f_T -> f_Tp -> usize -> Type0;
  f_f:#v_A: Type0 -> {| i2: t_Bar v_A |} -> x0: v_Self -> x1: f_T -> x2: f_Tp
    -> Prims.Pure usize
        (f_f_pre #v_A #i2 x0 x1 x2)
        (fun result -> f_f_post #v_A #i2 x0 x1 x2 result)
}
...
class t_T2 (v_Self: Type0) = {
  f_T:Type0;
  f_T_8131176285267814068:t_T1 f_T;
  f_f_pre:v_Self -> f_T -> Type0;
...
let impl_T2_for_S: t_T2 t_S =
  {
    f_T = t_S;
    f_T_8131176285267814068 = FStar.Tactics.Typeclasses.solve;
