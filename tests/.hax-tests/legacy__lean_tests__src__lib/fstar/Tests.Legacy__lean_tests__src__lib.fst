module Tests.Legacy__lean_tests__src__lib
...
(* item error backend: ((Diagnostics.Context.Backend FStar),
 Types.AssertionFailure {
   details =
   "Could not find item with UID (Attr_payloads.UId.T.UId \"240dbd04e88f420c8e0cda49c033892f\")"})

Last AST:
#[<cfg_attr>(hax_compilation, _hax ::
json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"240dbd04e88f420c8e0cda49c033892f\"}}}"))]#[_hax::json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"240dbd04e88f420c8e0cda49c033892f\"}}}")]#[allow(dead_code)]#[allow(unused_variables)]#[allow(dead_code)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
...
(* item error backend: ((Diagnostics.Context.Backend FStar),
 Types.AssertionFailure {
   details =
   "Could not find item with UID (Attr_payloads.UId.T.UId \"46d171144a2d45c3906cdaeed1394009\")"})

Last AST:
#[<cfg_attr>(hax_compilation, _hax ::
json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"46d171144a2d45c3906cdaeed1394009\"}}}"))]#[_hax::json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"46d171144a2d45c3906cdaeed1394009\"}}}")]#[allow(dead_code)]#[allow(unused_variables)]#[allow(dead_code)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
