module Tests.Legacy__traits__src__lib
...
class t_Foo (v_Self: Type0) = {
  f_AssocType:Type0;
  f_AssocType_10945004889129158312:t_SuperTrait f_AssocType;
  f_N:usize;
...
let impl_Foo_for_tuple_: t_Foo Prims.unit =
  {
    f_AssocType = i32;
    f_AssocType_10945004889129158312 = FStar.Tactics.Typeclasses.solve;
    f_N = mk_usize 32;
