module Tests.Legacy__traits__src__lib.Block_size
...
class t_ParBlocksSizeUser (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_6443092527138587040:t_BlockSizeUser v_Self
}

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_ParBlocksSizeUser v_Self|} -> i._super_6443092527138587040

class t_BlockBackend (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_12727045078389753918:t_ParBlocksSizeUser v_Self;
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_BlockBackend v_Self|} -> i._super_12727045078389753918
