...
## Procedure
 ...
 3. Update `aeneas-pin` and `charon-pin` to the latest release tags from [AeneasVerif/aeneas](https://github.com/AeneasVerif/aeneas/releases) and [AeneasVerif/charon](https://github.com/AeneasVerif/charon/releases). Verify with `./install-aeneas.sh` that the pinned versions work.
 4. PR the change
