...
def Tests.Legacy__reordering.Independent_cycles.c
  ...
  : Result Rust_primitives.Hax.Tuple0
  := do
  (← Tests.Legacy__reordering.Independent_cycles.a
...
def Tests.Legacy__reordering.Independent_cycles.a
  ...
  : Result Rust_primitives.Hax.Tuple0
  := do
  (← Tests.Legacy__reordering.Independent_cycles.c
      Rust_primitives.Hax.Tuple0.mk)
...
def Tests.Legacy__reordering.Independent_cycles.d
  ...
  : Result Rust_primitives.Hax.Tuple0
  := do
  (← Tests.Legacy__reordering.Independent_cycles.b
      Rust_primitives.Hax.Tuple0.mk)
...
def Tests.Legacy__reordering.Independent_cycles.b
  ...
  : Result Rust_primitives.Hax.Tuple0
  := do
  (← Tests.Legacy__reordering.Independent_cycles.d
      Rust_primitives.Hax.Tuple0.mk)
...
def Tests.Legacy__reordering.f
  ...
  := do
  Tests.Legacy__reordering.Foo.A
...
def Tests.Legacy__reordering.g
  ...
  := do
  (Tests.Legacy__reordering.Bar.mk (← Tests.Legacy__reordering.f (32 : u32)))
...
def Tests.Legacy__reordering.Foo
  ...
  := do
  (match x with
    | (Tests.Legacy__reordering.Foo.A ) => do (0 : isize)
    | (Tests.Legacy__reordering.Foo.B ) => do (1 : isize))