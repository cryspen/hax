...
//! 3. the built-in default shipped with this release.
//!
//! Declared-only `[versions]` entries resolve through the same order.
...
mod tests {
    ...
    #[test]
    fn versions_resolve_through_the_same_order() {
