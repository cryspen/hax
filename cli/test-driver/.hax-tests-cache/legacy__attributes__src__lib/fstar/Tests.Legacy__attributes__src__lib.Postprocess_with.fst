module Tests.Legacy__attributes__src__lib.Postprocess_with
...
[@@FStar.Tactics.postprocess_with ( fun temp_0_ ->
  ...
  Tests.Legacy__attributes__src__lib.Postprocess_with.Somewhere.some_hypothetical_tactic (mk_u8 12) )]
