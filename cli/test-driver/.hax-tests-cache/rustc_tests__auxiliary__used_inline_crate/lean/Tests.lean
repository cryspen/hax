...
def
  Tests.Rustc_tests__auxiliary__used_inline_crate.used_only_from_bin_crate_generic_function
...
def
  Tests.Rustc_tests__auxiliary__used_inline_crate.used_only_from_this_lib_crate_generic_function
  (T : Type) [(Core.Fmt.Debug T)] (arg : T)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let args : (RustArray Core.Fmt.Rt.Argument (1 : usize)) ← (pure
...
def
  Tests.Rustc_tests__auxiliary__used_inline_crate.used_from_bin_crate_and_lib_crate_generic_function
  (T : Type) [(Core.Fmt.Debug T)] (arg : T)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let args : (RustArray Core.Fmt.Rt.Argument (1 : usize)) ← (pure
...
def
  Tests.Rustc_tests__auxiliary__used_inline_crate.used_with_same_type_from_bin_crate_and_lib_crate_generic_function
  (T : Type) [(Core.Fmt.Debug T)] (arg : T)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let args : (RustArray Core.Fmt.Rt.Argument (1 : usize)) ← (pure
...
def Tests.Rustc_tests__auxiliary__used_inline_crate.unused_generic_function
  (T : Type) [(Core.Fmt.Debug T)] (arg : T)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let args : (RustArray Core.Fmt.Rt.Argument (1 : usize)) ← (pure
...
def Tests.Rustc_tests__auxiliary__used_inline_crate.unused_function
...
def Tests.Rustc_tests__auxiliary__used_inline_crate.unused_private_function
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let is_true : Bool ← (pure
...
def Tests.Rustc_tests__auxiliary__used_inline_crate.use_this_lib_crate
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let _ ← (pure
...
def Tests.Rustc_tests__auxiliary__used_inline_crate.used_function
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let is_true : Bool ← (pure
  ...
  let countdown : i32 ← (pure
    (← if is_true then do
      ...
      countdown));
  let _ ← (pure
    (← Tests.Rustc_tests__auxiliary__used_inline_crate.use_this_lib_crate
        Rust_primitives.Hax.Tuple0.mk));
  Rust_primitives.Hax.Tuple0.mk

def Tests.Rustc_tests__auxiliary__used_inline_crate.used_inline_function
  (_ : Rust_primitives.Hax.Tuple0)
  : Result Rust_primitives.Hax.Tuple0
  := do
  let is_true : Bool ← (pure
