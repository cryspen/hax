module Tests.Legacy__attribute_opaque__src__lib
...
assume
val ff_generic': v_X: usize -> #v_T: Type0 -> #v_U: Type0 -> x: v_U -> t_OpaqueEnum v_X v_T v_U

unfold
let ff_generic (v_X: usize) (#v_T #v_U: Type0) = ff_generic' v_X #v_T #v_U

assume
val f': x: bool -> y: bool -> bool
...
assume
val impl_S1__ff_s1': Prims.unit -> Prims.unit
...
assume
val impl_S2__ff_s2': Prims.unit -> Prims.unit
