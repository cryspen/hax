...
def Tests.Legacy__loops__src__lib.For_loops.range1
...
def Tests.Legacy__loops__src__lib.For_loops.range2
  (n : usize)
  : Result usize
  := do
  let acc : usize ← (pure (0 : usize));
...
def Tests.Legacy__loops__src__lib.For_loops.composed_range
  (n : usize)
  : Result usize
  := do
  let acc : usize ← (pure (0 : usize));
...
def Tests.Legacy__loops__src__lib.For_loops.rev_range
  (n : usize)
  : Result usize
  := do
  let acc : usize ← (pure (0 : usize));
...
def Tests.Legacy__loops__src__lib.For_loops.chunks
...
def Tests.Legacy__loops__src__lib.For_loops.iterator
...
def Tests.Legacy__loops__src__lib.For_loops.nested
  (arr : (Alloc.Vec.Vec usize Alloc.Alloc.Global))
  : Result usize
  := do
  let acc : usize ← (pure (0 : usize));
...
def Tests.Legacy__loops__src__lib.For_loops.pattern
  (arr :
...
def Tests.Legacy__loops__src__lib.For_loops.enumerate_chunks
  (arr : (Alloc.Vec.Vec usize Alloc.Alloc.Global))
  : Result usize
  := do
  let acc : usize ← (pure (0 : usize));
...
def Tests.Legacy__loops__src__lib.For_loops.bool_returning
  (x : u8)
  : Result Bool
  := do
  (← Rust_primitives.Hax.Machine_int.lt x (10 : u8))

def Tests.Legacy__loops__src__lib.For_loops.f
  (_ : Rust_primitives.Hax.Tuple0)
  ...
  (Rust_primitives.Hax.Tuple2.mk
    (← Rust_primitives.Hax.Folds.fold_range
        ...
        (fun acc i => (do
            ...
            let _ ← (pure
              (← Tests.Legacy__loops__src__lib.For_loops.bool_returning i));
            acc : Result u8)))
    Rust_primitives.Hax.Tuple0.mk)

def Tests.Legacy__loops__src__lib.Control_flow.double_sum
  (_ : Rust_primitives.Hax.Tuple0)
  : Result i32
  := do
...
def Tests.Legacy__loops__src__lib.Control_flow.double_sum2
  (_ : Rust_primitives.Hax.Tuple0)
  : Result i32
  := do
  let sum : i32 ← (pure (0 : i32));
...
def Tests.Legacy__loops__src__lib.Control_flow.double_sum_return
  (v : (RustSlice i32))
  : Result i32
  := do
  let sum : i32 ← (pure (0 : i32));
...
def Tests.Legacy__loops__src__lib.Control_flow.double_sum2_return
  (v : (RustSlice i32))
  : Result i32
  := do
  let sum : i32 ← (pure (0 : i32));
...
def Tests.Legacy__loops__src__lib.Control_flow.bigger_power_2
  (x : i32)
  : Result i32
  := do
...
structure Tests.Legacy__loops__src__lib.Control_flow.M where
  m : (Alloc.Vec.Vec u8 Alloc.Alloc.Global)

def Tests.Legacy__loops__src__lib.Control_flow.Impl.decoded_message
  (self : Tests.Legacy__loops__src__lib.Control_flow.M)
  ...
  (match
    (← Rust_primitives.Hax.Folds.fold_range_return
        ...
        (← Alloc.Vec.Impl_1.len u8 Alloc.Alloc.Global
            (Tests.Legacy__loops__src__lib.Control_flow.M.m self))
...
def Tests.Legacy__loops__src__lib.Control_flow.nested
  (_ : Rust_primitives.Hax.Tuple0)
  : Result i32
  := do
  let sum : i32 ← (pure (0 : i32));
...
def Tests.Legacy__loops__src__lib.Control_flow.nested_return
  (_ : Rust_primitives.Hax.Tuple0)
  : Result i32
  := do
  let sum : i32 ← (pure (0 : i32));
...
def Tests.Legacy__loops__src__lib.Control_flow.continue_only
  (x : (RustSlice i32))
...
def Tests.Legacy__loops__src__lib.Control_flow.continue_and_break
  (x : (RustSlice i32))
  : Result (Rust_primitives.Hax.Tuple2 i32 Rust_primitives.Hax.Tuple0)
  := do
  let product : i32 ← (pure (1 : i32));
...
def Tests.Legacy__loops__src__lib.While_loops.f
  (_ : Rust_primitives.Hax.Tuple0)
  : Result u8
  := do
  let x : u8 ← (pure (0 : u8));
...
def Tests.Legacy__loops__src__lib.While_loops.while_invariant_decr
  (_ : Rust_primitives.Hax.Tuple0)
  : Result u8
  := do
  let x : u8 ← (pure (0 : u8));
...
def Tests.Legacy__loops__src__lib.While_loops.while_invariant_decr_rev
  (_ : Rust_primitives.Hax.Tuple0)
  : Result u8
  := do
  let x : u8 ← (pure (0 : u8));
...
def Tests.Legacy__loops__src__lib.Recognized_loops.range
  (_ : Rust_primitives.Hax.Tuple0)
...
def Tests.Legacy__loops__src__lib.Recognized_loops.range_step_by
  (_ : Rust_primitives.Hax.Tuple0)
  : Result (Rust_primitives.Hax.Tuple2 u64 Rust_primitives.Hax.Tuple0)
  := do
  let count : u64 ← (pure (0 : u64));
...
def Tests.Legacy__loops__src__lib.Recognized_loops.enumerated_slice
...
def Tests.Legacy__loops__src__lib.Recognized_loops.enumerated_chunked_slice
  (T : Type) (slice : (RustSlice T))
  : Result (Rust_primitives.Hax.Tuple2 u64 Rust_primitives.Hax.Tuple0)
  := do
  let count : u64 ← (pure (0 : u64));
...
def Tests.Legacy__loops__src__lib.And_mut_side_effect_loop.looping
...
def Tests.Legacy__loops__src__lib.And_mut_side_effect_loop.looping_2
  (array : (RustArray u8 (5 : usize)))
  : Result (RustArray u8 (5 : usize))
  := do
