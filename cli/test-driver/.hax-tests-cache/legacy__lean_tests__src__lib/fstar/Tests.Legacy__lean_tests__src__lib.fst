...
(* item error backend: ((Diagnostics.Context.Backend FStar),
 Types.AssertionFailure {
   details =
   "Could not find item with UID (Attr_payloads.UId.T.UId \"88946f5433f5454382f71515748414e9\")"})

Last AST:
#[<cfg_attr>(hax_compilation, _hax ::
json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"88946f5433f5454382f71515748414e9\"}}}"))]#[_hax::json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"88946f5433f5454382f71515748414e9\"}}}")]#[allow(dead_code)]#[allow(unused_variables)]#[allow(dead_code)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
...
(* item error backend: ((Diagnostics.Context.Backend FStar),
 Types.AssertionFailure {
   details =
   "Could not find item with UID (Attr_payloads.UId.T.UId \"fab8469db9fd407992e550bf15be82f4\")"})

Last AST:
#[<cfg_attr>(hax_compilation, _hax ::
json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"fab8469db9fd407992e550bf15be82f4\"}}}"))]#[_hax::json("{\"AssociatedItem\":{\"role\":\"ItemQuote\",\"item\":{\"uid\":\"fab8469db9fd407992e550bf15be82f4\"}}}")]#[allow(dead_code)]#[allow(unused_variables)]#[allow(dead_code)]#[feature(register_tool, if_let_guard)]#[feature(coverage_attribute, stmt_expr_attributes, custom_inner_attributes, test,
