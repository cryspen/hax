module Tests.Legacy__lean_tests__src__lib.Traits.Inheritance
...
class t_T3 (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_17979165262813101021:t_T2 v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_13243193114793899321:t_T1 v_Self;
...
let _ = fun (v_Self:Type0) {|i: t_T3 v_Self|} -> i._super_17979165262813101021

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_T3 v_Self|} -> i._super_13243193114793899321
...
class t_Tp2 (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_5144147382296176775:t_Tp1 v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_13605484738848135905:t_T3 v_Self;
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_Tp2 v_Self|} -> i._super_5144147382296176775

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) {|i: t_Tp2 v_Self|} -> i._super_13605484738848135905
...
let impl_T3_for_S: t_T3 t_S =
  {
    _super_17979165262813101021 = FStar.Tactics.Typeclasses.solve;
    _super_13243193114793899321 = FStar.Tactics.Typeclasses.solve;
...
let impl_Tp2_for_S: t_Tp2 t_S =
  {
    _super_5144147382296176775 = FStar.Tactics.Typeclasses.solve;
    _super_13605484738848135905 = FStar.Tactics.Typeclasses.solve;
