module Tests.Legacy__traits__src__lib.Implicit_explicit_calling_conventions
...
class t_SubTrait (v_Self: Type0) (v_TypeArg: Type0) (v_ConstArg: usize) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_4980841138161911023:t_Trait v_Self
    v_TypeArg
    v_ConstArg;
  f_AssocType:Type0;
  f_AssocType_16357645131032764983:t_Trait f_AssocType v_TypeArg v_ConstArg
}

[@@ FStar.Tactics.Typeclasses.tcinstance]
let _ = fun (v_Self:Type0) (v_TypeArg:Type0) (v_ConstArg:usize) {|i: t_SubTrait v_Self v_TypeArg v_ConstArg|} -> i._super_4980841138161911023
