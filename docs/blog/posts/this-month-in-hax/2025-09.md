...
documentation in the [tutorial](https://hax.cryspen.com/manual/main/lean/tutorial/) and in the
[manual](https://hax.cryspen.com/manual/main/lean/). The F\*-*parity* and the
