...
function extract_and_copy() {
    go_to "./"
    HAX_CORE_MODELS_EXTRACTION_MODE=on cargo hax into -i '-**::rust_primitives::** -**::ops::arith::** -**::convert::**' fstar --interfaces '+!**::num::error +!**::panicking::internal +!core_models::borrow +!core_models::default +!core_models::error +!core_models::hash +!core_models::hint +!core_models::ops::bit'
