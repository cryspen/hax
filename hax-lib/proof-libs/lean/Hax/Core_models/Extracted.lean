...
class FromIterator (Self : Type) (A : Type)
  ...
  from_iter (Self) (A)
    (T : Type)
    [trait_constr_from_iter_associated_type_i0 : IntoIterator.AssociatedTypes T]
    [trait_constr_from_iter_i0 : IntoIterator T ] :
    (T -> RustM Self)
...
class IteratorMethods (Self : Type)
  ...
  fold (Self)
    (B : Type)
    (F : Type)
    [trait_constr_fold_associated_type_i0 :
      core_models.ops.function.FnOnce.AssociatedTypes
      F
      (rust_primitives.hax.Tuple2 B (Iterator.Item Self))]
    [trait_constr_fold_i0 : core_models.ops.function.FnOnce
      F
      (rust_primitives.hax.Tuple2 B (Iterator.Item Self))
      ] :
    (Self -> B -> F -> RustM B)
  ...
  all (Self)
    (F : Type)
    [trait_constr_all_associated_type_i0 :
      core_models.ops.function.FnOnce.AssociatedTypes
      F
      (Iterator.Item Self)]
    [trait_constr_all_i0 : core_models.ops.function.FnOnce
      F
      (Iterator.Item Self)
      ] :
    (Self -> F -> RustM Bool)
  ...
  flat_map (Self)
    (U : Type)
    (F : Type)
    [trait_constr_flat_map_associated_type_i0 : Iterator.AssociatedTypes U]
    [trait_constr_flat_map_i0 : Iterator U ]
    [trait_constr_flat_map_associated_type_i1 :
      core_models.ops.function.FnOnce.AssociatedTypes
      F
      (Iterator.Item Self)]
    [trait_constr_flat_map_i1 : core_models.ops.function.FnOnce
      F
      (Iterator.Item Self)
      ] :
    (Self -> F -> RustM (core_models.iter.adapters.flat_map.FlatMap Self U F))
  flatten (Self)
    [trait_constr_flatten_associated_type_i0 : Iterator.AssociatedTypes
      (Iterator.Item Self)]
    [trait_constr_flatten_i0 : Iterator (Iterator.Item Self) ] :
    (Self -> RustM (core_models.iter.adapters.flatten.Flatten Self))
  zip (Self)
    (I2 : Type)
    [trait_constr_zip_associated_type_i0 : Iterator.AssociatedTypes I2]
    [trait_constr_zip_i0 : Iterator I2 ] :
...
class PartialOrdDefaults (Self : Type) (Rhs : Type)
  ...
  where
  lt (Self) (Rhs)
    [trait_constr_lt_associated_type_i0 : PartialOrd.AssociatedTypes Self Rhs]
    [trait_constr_lt_i0 : PartialOrd Self Rhs ] :
    (Self -> Rhs -> RustM Bool)
  le (Self) (Rhs)
    [trait_constr_le_associated_type_i0 : PartialOrd.AssociatedTypes Self Rhs]
    [trait_constr_le_i0 : PartialOrd Self Rhs ] :
    (Self -> Rhs -> RustM Bool)
  gt (Self) (Rhs)
    [trait_constr_gt_associated_type_i0 : PartialOrd.AssociatedTypes Self Rhs]
    [trait_constr_gt_i0 : PartialOrd Self Rhs ] :
    (Self -> Rhs -> RustM Bool)
  ge (Self) (Rhs)
    [trait_constr_ge_associated_type_i0 : PartialOrd.AssociatedTypes Self Rhs]
    [trait_constr_ge_i0 : PartialOrd Self Rhs ] :
    (Self -> Rhs -> RustM Bool)
