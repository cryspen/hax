...
/-- Trait declaration: [alloc::alloc::Allocator]
    Source: 'src/lib.rs', lines 54:4-54:26
    Visibility: public -/
structure alloc.Allocator (Self : Type) where

/-- [alloc::alloc::Global]
    Source: 'src/lib.rs', lines 58:4-58:22
    Visibility: public -/
@[reducible]
def alloc.Global := Unit

/-- [alloc::borrow::Cow]
    Source: 'src/lib.rs', lines 64:4-64:21 -/
@[reducible]
