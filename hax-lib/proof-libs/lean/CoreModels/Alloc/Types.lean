...
/-- [alloc::collections::vec_deque::into_iter::IntoIter]
    Source: 'src/lib.rs', lines 367:12-367:83
    Visibility: public -/
def collections.vec_deque.into_iter.IntoIter (T : Type) (A : Type) :=
  rust_primitives.sequence.Seq T × core.marker.PhantomData A

/-- [alloc::slice::Dummy]
    Source: 'src/lib.rs', lines 526:4-526:23 -/
@[reducible]
def slice.Dummy (T : Type) := T

/-- [alloc::vec::Vec]
    Source: 'src/lib.rs', lines 757:4-757:34
    Visibility: public -/
@[reducible]
def vec.Vec (T : Type) := rust_primitives.sequence.Seq T

/-- [alloc::vec::into_iter::IntoIter]
    Source: 'src/lib.rs', lines 807:8-807:43
    Visibility: public -/
@[reducible]
