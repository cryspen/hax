...
class t_AddAssign (v_Self: Type0) (v_Rhs: Type0) = {
  f_add_assign_pre:v_Self -> v_Rhs -> prop;
  f_add_assign_post:v_Self -> v_Rhs -> v_Self -> prop;
...
class t_SubAssign (v_Self: Type0) (v_Rhs: Type0) = {
  f_sub_assign_pre:v_Self -> v_Rhs -> prop;
  f_sub_assign_post:v_Self -> v_Rhs -> v_Self -> prop;
...
class t_MulAssign (v_Self: Type0) (v_Rhs: Type0) = {
  f_mul_assign_pre:v_Self -> v_Rhs -> prop;
  f_mul_assign_post:v_Self -> v_Rhs -> v_Self -> prop;
...
class t_DivAssign (v_Self: Type0) (v_Rhs: Type0) = {
  f_div_assign_pre:v_Self -> v_Rhs -> prop;
  f_div_assign_post:v_Self -> v_Rhs -> v_Self -> prop;
...
class t_RemAssign (v_Self: Type0) (v_Rhs: Type0) = {
  f_rem_assign_pre:v_Self -> v_Rhs -> prop;
  f_rem_assign_post:v_Self -> v_Rhs -> v_Self -> prop;
...
class t_Add (v_Self: Type0) (v_Rhs: Type0) = {
  ...
  f_add_pre:v_Self -> v_Rhs -> prop;
  f_add_post:v_Self -> v_Rhs -> f_Output -> prop;
...
class t_Sub (v_Self: Type0) (v_Rhs: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]f_Output:Type0;
  f_sub_pre:v_Self -> v_Rhs -> prop;
  f_sub_post:v_Self -> v_Rhs -> f_Output -> prop;
...
class t_Mul (v_Self: Type0) (v_Rhs: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]f_Output:Type0;
  f_mul_pre:v_Self -> v_Rhs -> prop;
  f_mul_post:v_Self -> v_Rhs -> f_Output -> prop;
...
class t_Div (v_Self: Type0) (v_Rhs: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]f_Output:Type0;
  f_div_pre:v_Self -> v_Rhs -> prop;
  f_div_post:v_Self -> v_Rhs -> f_Output -> prop;
...
class t_Neg (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]f_Output:Type0;
  f_neg_pre:v_Self -> prop;
  f_neg_post:v_Self -> f_Output -> prop;
...
class t_Rem (v_Self: Type0) (v_Rhs: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]f_Output:Type0;
  f_rem_pre:v_Self -> v_Rhs -> prop;
  f_rem_post:v_Self -> v_Rhs -> f_Output -> prop;
