...
class t_Read (v_Self: Type0) = {
  ...
  f_read_post:v_Self -> t_Slice u8 -> (v_Self & t_Slice u8 & Core_models.Result.t_Result usize Std.Io.Error.t_Error)
    -> bool;
  ...
  f_read_exact_post:v_Self -> t_Slice u8 -> (v_Self & t_Slice u8 & Core_models.Result.t_Result unit Std.Io.Error.t_Error)
    -> bool;
  f_read_exact:x0: v_Self -> x1: t_Slice u8
    -> Prims.Pure (v_Self & t_Slice u8 & Core_models.Result.t_Result unit Std.Io.Error.t_Error)
