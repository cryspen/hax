...
class t_Read (v_Self: Type0) = {
  f_read_pre:self_: v_Self -> buf: t_Slice u8 -> pred: prop{true ==> pred};
  f_read_post:
      self_: v_Self ->
      buf: t_Slice u8 ->
  ...
  f_read_exact_pre:self_: v_Self -> buf: t_Slice u8 -> pred: prop{true ==> pred};
  f_read_exact_post:
      self_: v_Self ->
      buf: t_Slice u8 ->
...
class t_Write (v_Self: Type0) = {
  f_write_pre:self_: v_Self -> buf: t_Slice u8 -> pred: prop{true ==> pred};
  f_write_post:
      v_Self ->
      t_Slice u8 ->
  ...
  f_flush_pre:self_: v_Self -> pred: prop{true ==> pred};
  ...
  f_write_all_pre:self_: v_Self -> buf: t_Slice u8 -> pred: prop{true ==> pred};
  f_write_all_post:
      v_Self ->
      t_Slice u8 ->
