...
class t_FnOnce (v_Self: Type0) (v_Args: Type0) = {
  ...
  f_call_once_pre:self_: v_Self -> args: v_Args -> pred: prop{true ==> pred};
  f_call_once_post:v_Self -> v_Args -> f_Output -> prop;
...
class t_FnMut (v_Self: Type0) (v_Args: Type0) = {
  ...
  f_call_mut_pre:self_: v_Self -> args: v_Args -> pred: prop{true ==> pred};
  f_call_mut_post:v_Self -> v_Args -> (_super_i0).f_Output -> prop;
...
class t_Fn (v_Self: Type0) (v_Args: Type0) = {
  ...
  f_call_pre:self_: v_Self -> args: v_Args -> pred: prop{true ==> pred};
  f_call_post:v_Self -> v_Args -> (_super_i0)._super_i0.f_Output -> prop;
