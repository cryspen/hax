...
class t_RngCore (v_Self: Type0) = {
  f_next_u32_pre:v_Self -> prop;
  f_next_u32_post:v_Self -> (v_Self & u32) -> prop;
  f_next_u32:x0: v_Self
    -> Prims.Pure (v_Self & u32) (f_next_u32_pre x0) (fun result -> f_next_u32_post x0 result);
  f_next_u64_pre:v_Self -> prop;
  f_next_u64_post:v_Self -> (v_Self & u64) -> prop;
  f_next_u64:x0: v_Self
    -> Prims.Pure (v_Self & u64) (f_next_u64_pre x0) (fun result -> f_next_u64_post x0 result);
  f_fill_bytes_pre:v_Self -> t_Slice u8 -> prop;
  f_fill_bytes_post:v_Self -> t_Slice u8 -> (v_Self & t_Slice u8) -> prop;
