...
let impl_u8__checked_div (x y: u8) : Core_models.Option.t_Option u8 =
  if y =. mk_u8 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u8
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option u8

/// See [`std::primitive::u8::checked_rem`] (and similar for other integer types)
let impl_u8__checked_rem (x y: u8) : Core_models.Option.t_Option u8 =
  if y =. mk_u8 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u8
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option u8
...
/// See [`std::primitive::u8::checked_div`] (and similar for other integer types)
let impl_u16__checked_div (x y: u16) : Core_models.Option.t_Option u16 =
  if y =. mk_u16 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u16
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option u16

/// See [`std::primitive::u8::checked_rem`] (and similar for other integer types)
let impl_u16__checked_rem (x y: u16) : Core_models.Option.t_Option u16 =
  if y =. mk_u16 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u16
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option u16
...
/// See [`std::primitive::u8::checked_div`] (and similar for other integer types)
let impl_u32__checked_div (x y: u32) : Core_models.Option.t_Option u32 =
  if y =. mk_u32 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u32
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option u32

/// See [`std::primitive::u8::checked_rem`] (and similar for other integer types)
let impl_u32__checked_rem (x y: u32) : Core_models.Option.t_Option u32 =
  if y =. mk_u32 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u32
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option u32
...
/// See [`std::primitive::u8::checked_div`] (and similar for other integer types)
let impl_u64__checked_div (x y: u64) : Core_models.Option.t_Option u64 =
  if y =. mk_u64 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u64
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option u64

/// See [`std::primitive::u8::checked_rem`] (and similar for other integer types)
let impl_u64__checked_rem (x y: u64) : Core_models.Option.t_Option u64 =
  if y =. mk_u64 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u64
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option u64
...
/// See [`std::primitive::u8::checked_div`] (and similar for other integer types)
let impl_u128__checked_div (x y: u128) : Core_models.Option.t_Option u128 =
  if y =. mk_u128 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u128
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option u128

/// See [`std::primitive::u8::checked_rem`] (and similar for other integer types)
let impl_u128__checked_rem (x y: u128) : Core_models.Option.t_Option u128 =
  if y =. mk_u128 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option u128
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option u128
...
/// See [`std::primitive::u8::checked_div`] (and similar for other integer types)
let impl_usize__checked_div (x y: usize) : Core_models.Option.t_Option usize =
  if y =. mk_usize 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option usize
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option usize

/// See [`std::primitive::u8::checked_rem`] (and similar for other integer types)
let impl_usize__checked_rem (x y: usize) : Core_models.Option.t_Option usize =
  if y =. mk_usize 0
  then Core_models.Option.Option_None <: Core_models.Option.t_Option usize
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option usize
...
let impl_i8__checked_div (x y: i8) : Core_models.Option.t_Option i8 =
  if y =. mk_i8 0 || x =. impl_i8__MIN && y =. mk_i8 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i8
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option i8

/// See [`std::primitive::i8::checked_rem`] (and similar for other signed integer types)
let impl_i8__checked_rem (x y: i8) : Core_models.Option.t_Option i8 =
  if y =. mk_i8 0 || x =. impl_i8__MIN && y =. mk_i8 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i8
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option i8
...
/// See [`std::primitive::i8::checked_div`] (and similar for other signed integer types)
let impl_i16__checked_div (x y: i16) : Core_models.Option.t_Option i16 =
  if y =. mk_i16 0 || x =. impl_i16__MIN && y =. mk_i16 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i16
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option i16

/// See [`std::primitive::i8::checked_rem`] (and similar for other signed integer types)
let impl_i16__checked_rem (x y: i16) : Core_models.Option.t_Option i16 =
  if y =. mk_i16 0 || x =. impl_i16__MIN && y =. mk_i16 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i16
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option i16
...
/// See [`std::primitive::i8::checked_div`] (and similar for other signed integer types)
let impl_i32__checked_div (x y: i32) : Core_models.Option.t_Option i32 =
  if y =. mk_i32 0 || x =. impl_i32__MIN && y =. mk_i32 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i32
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option i32

/// See [`std::primitive::i8::checked_rem`] (and similar for other signed integer types)
let impl_i32__checked_rem (x y: i32) : Core_models.Option.t_Option i32 =
  if y =. mk_i32 0 || x =. impl_i32__MIN && y =. mk_i32 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i32
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option i32
...
/// See [`std::primitive::i8::checked_div`] (and similar for other signed integer types)
let impl_i64__checked_div (x y: i64) : Core_models.Option.t_Option i64 =
  if y =. mk_i64 0 || x =. impl_i64__MIN && y =. mk_i64 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i64
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option i64

/// See [`std::primitive::i8::checked_rem`] (and similar for other signed integer types)
let impl_i64__checked_rem (x y: i64) : Core_models.Option.t_Option i64 =
  if y =. mk_i64 0 || x =. impl_i64__MIN && y =. mk_i64 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i64
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option i64
...
/// See [`std::primitive::i8::checked_div`] (and similar for other signed integer types)
let impl_i128__checked_div (x y: i128) : Core_models.Option.t_Option i128 =
  if y =. mk_i128 0 || x =. impl_i128__MIN && y =. mk_i128 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i128
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option i128

/// See [`std::primitive::i8::checked_rem`] (and similar for other signed integer types)
let impl_i128__checked_rem (x y: i128) : Core_models.Option.t_Option i128 =
  if y =. mk_i128 0 || x =. impl_i128__MIN && y =. mk_i128 (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option i128
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option i128
...
/// See [`std::primitive::i8::checked_div`] (and similar for other signed integer types)
let impl_isize__checked_div (x y: isize) : Core_models.Option.t_Option isize =
  if y =. mk_isize 0 || x =. impl_isize__MIN && y =. mk_isize (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option isize
  else Core_models.Option.Option_Some (x /! y) <: Core_models.Option.t_Option isize

/// See [`std::primitive::i8::checked_rem`] (and similar for other signed integer types)
let impl_isize__checked_rem (x y: isize) : Core_models.Option.t_Option isize =
  if y =. mk_isize 0 || x =. impl_isize__MIN && y =. mk_isize (-1)
  then Core_models.Option.Option_None <: Core_models.Option.t_Option isize
  else Core_models.Option.Option_Some (x %! y) <: Core_models.Option.t_Option isize
