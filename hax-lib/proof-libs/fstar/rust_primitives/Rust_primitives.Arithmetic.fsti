...
let overflowing_sub_usize (x y: usize): usize & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 size + sub else sub in
    (mk_usize out, borrow)
...
let overflowing_sub_i8 (x y: i8): i8 & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 8 + sub else sub in
    (mk_i8 out, borrow)
...
let overflowing_sub_i16 (x y: i16): i16 & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 16 + sub else sub in
    (mk_i16 out, borrow)
...
let overflowing_sub_i32 (x y: i32): i32 & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 32 + sub else sub in
    (mk_i32 out, borrow)
...
let overflowing_sub_i64 (x y: i64): i64 & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 64 + sub else sub in
    (mk_i64 out, borrow)
...
let overflowing_sub_i128 (x y: i128): i128 & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 128 + sub else sub in
    (mk_i128 out, borrow)
...
let overflowing_sub_isize (x y: isize): isize & bool
  = let sub = v x - v y in
    let borrow = sub < 0 in
    let out = if borrow then pow2 size + sub else sub in
    (mk_isize out, borrow)
