...
Record Range_Range_record (v_Idx : Type) `{core.marker.t_Sized (v_Idx)} : Type :=
  {
...
#[export] Instance settable_Range_Range_record `{v_Idx : Type} `{core.marker.t_Sized (v_Idx)} : Settable _ :=
