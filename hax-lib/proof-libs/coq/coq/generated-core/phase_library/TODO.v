...
Notation "Alloc_String.t_String" := t_String.
Definition ToString__f_to_string (x : string) : string := x.
Notation "Alloc_String.ToString__f_to_string" := ToString__f_to_string.
