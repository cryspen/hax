...
Changes to hax-lib:
 ...
 - Qualify `Self::Assoc` projections in the pre and post-conditions generated by `#[hax_lib::attributes]`, so that specifications can be attached to methods whose signature mentions an associated type (#2089)
