...
The engine is designed to behave like a "pure" function.
 ...
 [`EngineOptions`](../hax-types/src/engine_api.rs): note this
 ...
 7. The backend produces a list of
    [`File`](../hax-types/src/engine_api.rs)s. Each phase might also
 ...
 8. Gathering files and diagnostics, we make a
    [`Output`](../hax-types/src/engine_api.rs) value, serialize it
...
Those visitors are generated by `utils/generate_from_ast`.
