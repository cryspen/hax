    ...
    pub mod hax {
        ...
        pub mod control_flow_monad {
            ...
            pub mod ControlFlowMonad {
                #![doc = r##"This is the trait [`::hax_engine_names::hax::control_flow_monad::ControlFlowMonad`]."##]
                pub use super::root;
                mk!(
                    lift,
                    r##"This is the associated function [`::hax_engine_names::hax::control_flow_monad::ControlFlowMonad::lift`]."##,
